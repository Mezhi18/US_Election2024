...
As our paper is about the 2024 United States federal election and more specifically we are looking at the polls and the polling data comparing the two candidates, former President Donald Trump and Vice President Kamala Harris, for the upcoming election. Our orignal Data set had over 16,000 unique entries from different pollsters, the business or Organization that conducts the poll. Each poll has two entries one giving the Data for the polling a opinions of Donald Trump and the second for Kamala Harris. We have aquired our polling data from @bibnotmadeyet.

As there are over 50 variables many of which are redundent to our paper we will only discuss those that we have kept in our clean data as they are the only ones we use in our analysis.
...
**question_id:** This varible refers to the question that was asked in the specific poll.
...
**pct:** This tells us the percentage of participents that intend to vote for the selected candidate.

**start_date:** The date the pollster began conducting the poll.

**end_date:** The date the pollster finished conducting the poll.

**num_harris:** The numbner of participants that intend to vot for Kamala Harris.
